...
| Contract | Address |
|----------|---------|
| MercuryToken | _at launch_ |
| Staking | _at launch_ |
| TreasuryV3 | _at launch_ |
| AffiliateRegistry | _at launch_ |
| LpTimelock | _at launch_ |
| DrandSource / DrandBeacon | _at launch_ |
| GridMining | _at launch_ |
| AutoMiner | _at launch_ |
