...
// NOTE: vendored verbatim from frogworksio/anyrand
// (audit 2024-10-14). Only two non-logic deviations: (1) pragma relaxed
// 0.8.28 -> ^0.8.24 to match the repo's solc (no 0.8.25+ feature is used
// here), (2) imports repointed to the vendored siblings in this dir.
// The verification logic is byte-for-byte the audited DrandBeacon.
